...
func (e UserEdges) EvaluationsOrErr() ([]*Evaluation, error) {
	if e.loadedTypes[0] {
...
// QueryEvaluations queries the "evaluations" edge of the User entity.
func (u *User) QueryEvaluations() *EvaluationQuery {
	return NewUserClient(u.config).QueryEvaluations(u)
}
