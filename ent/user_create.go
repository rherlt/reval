...
func (uc *UserCreate) AddEvaluationIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddEvaluationIDs(ids...)
	return uc
}

// AddEvaluations adds the "evaluations" edges to the Evaluation entity.
func (uc *UserCreate) AddEvaluations(e ...*Evaluation) *UserCreate {
	ids := make([]uuid.UUID, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
	return uc.AddEvaluationIDs(ids...)
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.ExternalId(); !ok {
		return &ValidationError{Name: "externalId", err: errors.New(`ent: missing required field "User.externalId"`)}
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.EvaluationsIDs(); len(nodes) > 0 {
...
func (u *UserUpsert) ClearType() *UserUpsert {
	u.SetNull(user.FieldType)
	return u
}
...
// ClearType clears the value of the "type" field.
func (u *UserUpsertOne) ClearType() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.ClearType()
	})
}
...
// ClearType clears the value of the "type" field.
func (u *UserUpsertBulk) ClearType() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.ClearType()
	})
}
